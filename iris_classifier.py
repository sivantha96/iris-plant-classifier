...
def predict_category(model, encoder, val_A, val_B, val_C, val_D):
    # define a dataframe from values
    df = pd.DataFrame([val_A, val_B, val_C, val_D])
...
print(predict_category(model, encoder, 5.1, 3.5, 1.4, 0.2))
